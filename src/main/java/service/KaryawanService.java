...
public class KaryawanService {
    ...
    public void tampilKaryawan(JPanel panelTarget, String key) {
        ...
        // Mengatur warna background utama menjadi coklat
        ...
        try {
            for (Karyawan k : daftarKaryawan) {
                ...
                cardPanel.setBackground(new Color(139, 90, 43)); // coklat muda // Warna background orange
                ...
                tombolEdit.addActionListener((ActionEvent e) -> {
                    ...
                    AdminPage.txtKRJabt.setSelectedItem(k.getJabatan());
